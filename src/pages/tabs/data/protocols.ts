...
export const LIQUID_STAKING_PROTOCOLS = [
  ...
  },
  {
    ...
    protocol: "Pryzm",
    chain: "Pryzm",
    title: "Liquid Stake ATOM → przATOM",
    description:
    ...
    risks: ["Smart-contract", "Unbonding"],
    howItWorks: [
      "IBC ATOM to Pryzm network",
      "Stake via Turbo Liquid Staking",
      "Receive przATOM tokens",
      "Use przATOM in DeFi while earning high yields",
      "Redeem anytime via DEX",
    ],
    links: {
